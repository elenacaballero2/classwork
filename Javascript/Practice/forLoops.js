...
for (var n = 0; ((n <= winniesFavoriteNumber) || (n <= kaisFavoriteNumber)); n++){
	if ( n===winniesFavoriteNumber){
		console.log("Winnie's Favorite Number");
		console.log(n);
		break;
	} else if (n===kaisFavoriteNumber){
			console.log("Kai's Favorite Number");
			console.log(n);
			break;
		}
}
...
console.log("While Loop COUNT BACKWARD FROM SIX");
var n = 6;
...
console.log("While Loop SUM EVENS");
// Write your code here:
var i = 0;
while (i <= limit){
	i ++
...
console.log("While Loop FIND A FAVORITE NUMBER");
// Write your code here:
var n = 0;
